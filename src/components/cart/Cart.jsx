            ...
            <div className='container'>
                <div className='row'>
                    <div className='col-md-12 text-center'>
                        ...
                        <Link to={"/"} className="btn btn-outline-danger">Volver a la página principal</Link>
                    </div>
                </div>
            </div>
        )
        ...
        <div>
            <table className="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colSpan={3}>&nbsp;</td>
                        <td className="text-center"><Link onClick={clear} className="btn btn-outline-danger m-4">
                            Vaciar Carrito
                        </Link>
                        </td>
                        <td ><Link to={"/checkout"} className='btn btn-outline-danger m-4'>Finalizar Compra</Link></td>
                    </tr>
                </tbody>
            </table>
        </div>
